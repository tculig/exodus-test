      ...
      <Container className="t-asset-page-header-content">
        ...
        <div className="t-asset-page-header-actions x-break-sm">
          <Dropdown className="t-platform-dropdown t-platform-dropdown--Desktop">
            <Dropdown.Toggle className="t-toggle" style={{ background: "linear-gradient(to right, #FFC82D,#FE9D39)" }}>
              ...
              <span className="t-toggle-label">Download Desktop</span>
              <span className="t-toggle-picker">
          ...
          <Dropdown className="t-platform-dropdown t-platform-dropdown--Mobile">
            <Dropdown.Toggle className="t-toggle" style={{ background: "linear-gradient(to right, #FFC82D,#FE9D39)" }}>
              ...
              <span className="t-toggle-label">Download Mobile</span>
              <span className="t-toggle-picker">
                <svg width={11} height={7} viewBox="0 0 11 7" fill="none">
                  <path opacity="0.8" d="M1 1L5.5 5.5L10 1" stroke="white" />
                </svg>
          ...
          <Dropdown className="t-platform-dropdown t-platform-dropdown--Extension">
            <Dropdown.Toggle className="t-toggle" style={{ background: "linear-gradient(to right, #FFC82D,#FE9D39)" }} href="https://www.exodus.com/install-forwarder/extension/?utm_source=exodus-website&utm_campaign=btc-wallet&utm_content=btc-wallet&referrer=https%3A%2F%2Fgithub.com%2F">
              <i className="t-toggle-icon">
                <svg width={24} height={24} viewBox="0 0 24 24" fill="none">
                  <title>Desktop</title>
